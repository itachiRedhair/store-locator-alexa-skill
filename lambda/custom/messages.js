...
module.exports = Object.freeze({
  GREETING:
    "<prosody rate='93%'>Well hello there!</prosody> Welcome to the CENSORED Store Locator.",
  ...
  cardGenerators: {
    getDefaultCard: () => {
      const bgImage = new Alexa.ImageHelper()
        .addImageInstance(
          "https://s3.amazonaws.com/CENSORED-alexa-skill/CENSOREDSkillBackground.jpeg"
        )
        .getImage();
      const CENSOREDLogo = new Alexa.ImageHelper()
        .withDescription("Google Map")
        .addImageInstance(
          "https://cdn.macrumors.com/article-new/2016/10/CENSORED-fcc.jpg"
        )
        .getImage();

      const titleText = `<font size="7">CENSORED</font><br/>`;
